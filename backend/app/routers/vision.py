...
# Lazy import to avoid loading heavy ML dependencies during tests
if TYPE_CHECKING:
    from core_engine.vision.image_processor import ImageProcessor

from app.models import ImageProcessingResponse, Detection
...
async def detect_objects(
    ...
    vision_processor = Depends(get_vision_processor)
):
    """
